# XR Guild — brand discovery notes

Working file. Answers captured verbatim as the discovery conversation progresses.
This is the input to the brand guide; nothing here is final until confirmed.
